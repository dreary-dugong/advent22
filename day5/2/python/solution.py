#!/bin/python3
# solution for https://adventofcode.com/2022/day/5 part 2
...
def main():
    ...
    for instruction in instructions.split("\n"):
        ...
        # add crates to temporary stack to reverse order to simulate all crates being moved at once
        temp_stack = []
        for _ in range(num_crates):
            cur_crate = starting_stack.pop()
            temp_stack.append(cur_crate)

        # move from temporary stack to the destination
        while temp_stack:
            cur_crate = temp_stack.pop()
